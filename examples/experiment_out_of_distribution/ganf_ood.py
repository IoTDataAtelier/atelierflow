...
from mtsa.models import GANF  
from examples.experiment_out_of_distribution.isolation_forest_ood_steps import PrepareFoldsStep
from examples.experiment_out_of_distribution.ganf_ood_steps import LoadDataStep, TrainModelStep, EvaluateModelStep, AppendResultsStep
...
def main():
    ...
    experiment = ExperimentBuilder('Out-of-Distribution GANF Experiment')
    experiment.set_avro_schema(avro_schema)
    
    batch_size_values = [512, 256, 128, 64, 32]
    ...
    experiment.add_model(ganf_config)
    
    experiment.add_metric(ROCAUC())
    
    model_name = ganf_config.model_class.__name__
